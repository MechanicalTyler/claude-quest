...
- **Hard-fail rules are never overridden by agent judgment** — Some documented rules are deterministic and non-negotiable; an agent's own judgment is never a way around them:
