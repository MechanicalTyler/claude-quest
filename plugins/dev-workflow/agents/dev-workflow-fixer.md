...
description: >
  ...
  addressing-pr-comments skill in an isolated subagent context. Dispatched by
...
The dispatching orchestrator gives you a **PR number**. Because addressing-pr-comments
...
You cannot ask the user anything. addressing-pr-comments does **not** emit a key/value
